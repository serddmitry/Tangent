...
import { deltaHasTextChanges, getEditInfo, getLineRangeWhile, getRangeWhile, lineToText, snapPositionOutOfHiddenLinkBrackets, snapPositionPastTrailingLinkBrackets } from 'common/typewriterUtils'
